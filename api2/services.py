...
class AuthService:
    ...
    def _get_client():
        ...
        if client is None:
            ...
            abort(503, description="Database not configured. Please check Supabase URL and Key.")
        return client
    ...
    def register_student(data):
        ...
        if not email or not password or not name or not course or not roll_number:
            ...
            # Provide detailed error message in description for the global handler
            abort(400, description="name, roll_number, course, email, and password are required")
